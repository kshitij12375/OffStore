   ...
   return(
    ...
    <li><a class="dropdown-item" href="#">Traditionals</a></li>
      ...
      <div id="womensFashion" className="grid">
        ...
        <div>Casual Bell Sleeves Embroidered Women Top</div>
          <div className='gridd'>
        ...
        <div>Cupid's Gem Ring for Women Jewellery Accessories Copper Ring</div>
          <div className='gridd'>
        ...
        <div>Premium Helios Danglers For Women Steel Drops & Danglers</div>
          <div className='gridd'>
       ...
       <div className="card flexbox" id='cw7'><img src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/shop/product-16-2.jpg"alt="" /></div>
        ...
        <div>Women Oversized Fit Solid Spread Collar Casual Shirt</div>
          <div className='gridd'>
        ...
        <div>Women Regular Fit Floral Print Curved Collar Casual Shirt</div>
          <div className='gridd'>
        ...
        <div className="details" id='tw9'>
          <div>OGL-09 Casual Shoes for Women | Trendy Lace-Up Sneakers For Women</div>
          <div className='gridd'>
        ...
        <div>Women Mesh Stylish Casual Comfort Sneakers For Women</div>
          <div className='gridd'>
        ...
        <div className="details" id='tw11'>
          <div>Gradient, UV Protection Wayfarer Sunglasses</div>
          <div className='gridd'>
        ...
        <div>by Lenskart UV Protection Cat-eye Sunglasses </div>
          <div className='gridd'>
        ...
        <div className="details" id='tw13'>
          <div>Analog Watch - For Women VH000008D</div>
          <div className='gridd'>
        ...
        <div className="details" id='tw15'>
          <div>Casual Stylish Trending Sneakers For Women  (White , 5)</div>
          <div className='gridd'>
        ...
        <div>CAMP-CLINT Sneakers For Women  (White , 7)</div>
          <div className='gridd'>
