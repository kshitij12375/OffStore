  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="next">
    ...
    <span className="visually-hidden">Next</span>
        ...
        <div className="home2">
            <div className='card1'>
                <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n7.jpg" alt="shirt4"></img>
                    <div className='card3'>
            ...
            <div className='card1'> 
            <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n1.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
            ...
            <div className='card1'>
            <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n3.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
            ...
            <div className='card1'>
            <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n4.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
            ...
            <div className='card1'>
                <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n5.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
            ...
            <div className='card1'>
            <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n6.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
            ...
            <div className='card1'>
            <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n8.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
            ...
            <div className='card1'>
            <div className='card2'>
                    <img src="https://6497b763e8a77346f1b0bbd4--idyllic-brigadeiros-146de5.netlify.app/n2.jpg" alt="shirt4"></img>
                    <div className='card3'>
                    <p id='h'>Mast and Habour</p>
                    <p>Pure Cotton and tailored Shirt</p>
                    <p id ="w">Rs.999</p>
